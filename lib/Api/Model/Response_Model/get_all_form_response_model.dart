...
GetAllFormsResponseModel getAllFormsResponseModelFromJson(String str) =>
    GetAllFormsResponseModel.fromJson(json.decode(str));

String getAllFormsResponseModelToJson(GetAllFormsResponseModel data) =>
    json.encode(data.toJson());

class GetAllFormsResponseModel {
  String status;
  String message;
  List<Datum> data;

  GetAllFormsResponseModel({
    required this.status,
    required this.message,
    required this.data,
  });

  factory GetAllFormsResponseModel.fromJson(Map<String, dynamic> json) =>
      GetAllFormsResponseModel(
        status: json["status"],
